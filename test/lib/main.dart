...
class _MyHomePageState extends State<MyHomePage> {
        ...
        child: Center(
          child: Container(
            ...
            child: _buildFlipAnimation(
                url: 'https://picsum.photos/250?image=6', text: "string"),
          ),
        ),
      ),
    );
  ...
  Widget _buildFlipAnimation({String url, String text}) {
    DecorationImage image = DecorationImage(image: NetworkImage(url));
    return GestureDetector(
      ...
      child: AnimatedSwitcher(
        ...
        child: _showFrontSide ? _buildFront(text) : _buildRear(image),
  ...
  Widget __buildLayout(
    ...
    return Container(
      ...
      child: Center(
        child: Text(faceName, style: TextStyle(fontSize: 40.0)),
      ),
    );
    // return Container(
    //   key: key,
